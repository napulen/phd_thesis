...
% These results were confirmed by other researchers \cite{albrecht_use_2013}. In future experiments, Sapp \cite{sapp_computational_2011} showed that, when unable to predict the correct key, the Aarden-Essen distribution tends to favor the subdominant instead of the tonic.
