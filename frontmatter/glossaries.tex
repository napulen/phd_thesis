...
\newglossaryentry{realize}{name=chord realization,
description={A chord realization refers to arranging a chord
into a note arrangement based on a label. For example, if a
chord is indicated as $\rn{F:V}\rnseven$, one realization
consists of the set of notes ${C, E, G, B\flat}$}}
