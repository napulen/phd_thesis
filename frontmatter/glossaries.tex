...
well-known ``circle of fifths'' that occurs when enharmonic
nonequivalence is assumed. In the circle of fifths, the
pitches in the circle repeat because it is assumed that two
enharmonic pitches have the same location in the circle
(e.g., $\pitchGb$ and $\pitchFs$). In the line of fifths,
however, the ``sharper'' and ``flatter'' pitches are, they
further away they are. See \textcite{temperley2000line} for
