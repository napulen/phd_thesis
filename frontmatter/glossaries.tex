...
\newglossaryentry{bass19}{name=LowestNote19, description={An input
representation of the proposed neural network described in
\refsubsec{bassinput} }}

\newglossaryentry{chroma19}{name=Notes19, description={An
input representation of the proposed neural network
described in \refsubsec{spelledchromainput} }}

\newglossaryentry{duration14}{name=Onsets14, description={An
...
\newglossaryentry{rn31}{name=Numerator31,
description={An output representation of the proposed neural
...
% Note symbols
\newacronym[plural=$\musThirtySecond$, firstplural=32\textsuperscript{nd} ($\musThirtySecond$)]{32nd}{$\musThirtySecond$}{A thirty-second note}
\newacronym[plural=$\musSixteenth$, firstplural=16\textsuperscript{th} ($\musSixteenth$)]{16th}{$\musSixteenth$}{A sixteenth note}
\newacronym[plural=$\musEighth$, firstplural=8\textsuperscript{th} ($\musEighth$)]{8thth}{$\musEighth$}{An eighth note}
\newacronym[plural=$\musQuarter$, firstplural=quarter ($\musQuarter$)]{quarter}{$\musQuarter$}{A quarter note}
\newacronym[plural=$\musHalf$, firstplural=half ($\musHalf$)]{half}{$\musHalf$}{A half note}
\newacronym[plural=$\musWhole$, firstplural=whole ($\musWhole$)]{whole}{$\musWhole$}{A whole note}
