...
\newglossaryentry{cadentialsixfour}{name=cadential six-four,
description={The \emph{cadential six-four} is a tonic triad
in second inversion. When the chord is used in a cadential
context, it receives this special name. The ``six-four''
refers to the Arabic numerals written next to the Roman
numeral. This chord is often a source of disagreement in
music theory, because it lies at the boundary of verticality
(a tonic chord root, arranged in second inversion) and
horizontality (a dominant chord with a double suspension) in
harmonic analysis. See
\refsec{standardizationofromannumeralannotations} for a
longer discussion of this chord in Roman numeral analysis}
...
\newglossaryentry{dotproduct}{name=dot product,
description={Given two equal-length sequences of numbers,
the dot product is given by $a \dot b = \sum_{i=1}^{n} a_i
b_i$}}
...
and applied on global-key estimation problems since
...
away from the origin of the line of fifths they are. See
\textcite{moss2022line, temperley2000line} for an extensive
...
\newglossaryentry{natem}{name=NaTEM,description={The
Numerator and Tonicization Estimation Method (NaTEM) is an
algorithm to retrieve a Roman numeral numerator $\elnum$ and
tonicization $\elden$ when only a \gls{pcset} $\elpcset$ and
key $\elkey$ are known. See
\refsec{thenumeratorandtonicizationestimationmethod} for
...
of the tuple of notes $(\pitchC{}4, \, \pitchE{}4, \,
\pitchG{}4, \, \pitchBb{}4)$, whereas a different
realization consists of the notes $(\pitchC{}4, \,
\pitchG{}4, \, \pitchE{}5, \, \pitchBb{}5)$}}

\newglossaryentry{romantext}{name=RomanText, description={A
digital standard for Roman numeral analysis introduced in
\textcite{gotham2019romantext}}}

\newglossaryentry{spine}{name=spine, description={In the
context of the \emph{Humdrum} family of formats, a spine is
a column of data}}

\newglossaryentry{vanishingexploding}{name=vanishing
gradients, description={Vanishing and exploding gradients
are undesirable effects during the training of an artificial
neural network. They consist of either negligible
(vanishing) or very large (exploding) updates to the
trainable parameters. In the first instance, it leads to no
learning, in the second instance, it leads to numerical
instability. This effect was noticeable in Recurrent Neural
Networks, and it made them difficult to train. See
\textcite{bengio1994learning} for further information on
this topic}}
...
neural network proposed in this dissertation. See
\refsubsubsec{lowestsoundingnote} for further details on
this representation }}

\newglossaryentry{chroma19}{name=Notes19, description={One
of the three input representations in the neural network
proposed in this dissertation. See
\refsubsubsec{allsoundingnotes} for further details on this
representation }}

\newglossaryentry{duration14}{name=Onsets14,
description={One of the three input representations in the
neural network proposed in this dissertation. See
\refsubsubsec{measureandnoteonsets} for further details on
this representation  }}
...
in this dissertation. See \refsubsec{Bass35} for further
details }}

\newglossaryentry{tenor35}{name=Tenor35, description={One of
the nine classification tasks in the neural network proposed
in this dissertation. See \refsubsec{Tenor35} for further
details }}

\newglossaryentry{alto35}{name=Alto35, description={One of
the nine classification tasks in the neural network proposed
in this dissertation. See \refsubsec{Alto35} for further
details }}
...
neural network proposed in this dissertation. See
\refsubsec{Soprano35} for further details  }}
...
$|\elpcset| = 3 $ or $|\elpcset| = 4$ that contains the
...
description={One of the nine classification tasks in the
neural network proposed in this dissertation. See
\refsubsec{PitchClassSet121} for further details }}

\newglossaryentry{rn31}{name=Numerator31, description={One
of the nine classification tasks in the neural network
proposed in this dissertation. See \refsubsec{Numerator31}
for further details }}

\newglossaryentry{localkey38}{name=LocalKey38,
description={One of the nine classification tasks in the
neural network proposed in this dissertation. See
\refsubsec{LocalKey38} for further details  }}

\newglossaryentry{tonicization38}{name=Tonicization38,
description={One of the nine classification tasks in the
neural network proposed in this dissertation. See
\refsubsec{TonicizationKey38} for further details  }}

\newglossaryentry{harmonicrhythm7}{name=HarmonicRhythm7,
description={One of the nine classification tasks in the
neural network proposed in this dissertation. See
\refsubsec{HarmonicRhythm7} for further details  }}
...
% \newacronym{natem}{NaTEM}{Numerator and Tonicization
% Estimation Method}
...
\newacronym[plural=$\musQuarterDotted$, firstplural=dotted quarter ($\musQuarterDotted$)]{dottedquarter}{$\musQuarterDotted$}{Dotted quarter note}
\newacronym[plural=$\musHalf$, firstplural=half ($\musHalf$)]{half}{$\musHalf$}{Half note}
\newacronym[plural=$\musHalfDotted$, firstplural=dotted half ($\musHalfDotted$)]{dottedhalf}{$\musHalfDotted$}{Dotted half note}
