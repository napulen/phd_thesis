...
\emph{Melisma Music Analyzer} is a suite of programs for
music analysis. One of the analytical features of the model
is automatic Roman numeral analysis. After the contributions
by Sapp, the \emph{Melisma} Roman numeral analysis module
probably became the first end-to-end Roman numeral analysis
system. See \textcite{napoleslopez2017automatic} for a
discussion of the different components of the Roman numeral
analysis component of Melisma}}
