...
concise. Previously, it is used in the form of $\rn{I--V}$
and $\rn{I--IV}$, denoting chords that act as tonics in one
key and as dominants in another. However, that would not
work for $\rn{V--V}$,\footnote{Which should perhaps be
