...
is extended to describe special chords, beyond the diatonic
harmonies occurring in major and minor scales. This is an
important characteristic of the notation to this day, as
these chords are generally not annotated in chord label
syntaxes. Emery also introduced a special symbol to annotate
Neapolitan chords,\footnote{Another kind of chord that is
generally ignored in the chord label vocabulary beyond
\gls{rna}} $\rn{N.6}$. 
