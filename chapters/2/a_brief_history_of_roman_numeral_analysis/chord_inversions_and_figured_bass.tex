...
\begin{italicquotes}
    ...
    $\rn{I}_\rnformat{c}$, $\rn{ii}\rndim^7_\rnformat{a}$,
    $\rn{ii}\rndim^7_\rnformat{b}$,
    $\rn{ii}\rndim^7_\rnformat{c}$,
    $\rn{IV}^\rnformat{+}_\rnformat{a}$, $\rn{iii}^7_c$,
    etc. The diminished seventh chord, in its various forms,
    will be marked: $\rn{vii}\rndim_7$,
    ...
    --- \textcite[page~4]{cutter1902harmonic}
\end{italicquotes}
