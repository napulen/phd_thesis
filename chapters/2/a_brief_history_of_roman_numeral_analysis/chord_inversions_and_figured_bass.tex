...
\begin{italicquotes}
    ...
    marked: $\rn{vii}^\rnformat{o}_\rnformat{7}$,
    $\rn{vii}\rndim\rnsixfive$,
    $\rn{vii}\rndim\rnfourthree$, $\rn{vii}\rndim\rnfourtwo$
    --- or $\rn{vii}^{\rnformat{o}}_{\rnformat{a}}{}^\rnformat{7}$,
    $\rn{vii}^{\rnformat{o}}_{\rnformat{b}}{}^\rnformat{7}$,
    $\rn{vii}^{\rnformat{o}}_{\rnformat{c}}{}^\rnformat{7}$,
    $\rn{vii}^{\rnformat{o}}_{\rnformat{d}}{}^\rnformat{7}$.
