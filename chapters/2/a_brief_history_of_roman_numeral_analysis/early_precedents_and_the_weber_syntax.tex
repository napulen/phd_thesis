...
% which introduces the early precedents and the weber syntax.

% Copyright 2022 Néstor Nápoles López

% This is \refsubsec{theromannumeraltimeline},
% which introduces the the roman numeral timeline.


The first use of Roman numerals to indicate scale-degree
relationships was by \textcite{kirnberger1774kunst}. These
appeared in two tables of \emph{Die Kunst der reinen Satzes
in der Musik}, shown in
\reffig{primary_sources/kirnberger1774kunst015}.

\phdtwofigures[Roman numerals in \textcite{kirnberger1774kunst}][Roman numerals in \textcite{vogler1778grunde}][0.4][0.6]{primary_sources/kirnberger1774kunst015}{primary_sources/vogler1778grunde021}
