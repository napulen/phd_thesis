...
\gls{rna}. For example, changes of key are indicated using a
colon ``$\rn{:}$'' symbol and analyses with several rows of
keys and Roman numeral indications appear in modulating
passages. Finally, whereas previous theorists used the Roman
numeral notations sporadically, Weber exercised this
notation thoroughly in the
