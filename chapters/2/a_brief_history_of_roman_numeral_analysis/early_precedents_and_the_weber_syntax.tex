...
\parencite{weber1817versuch}. The notation chosen by Weber
to indicate dominant seventh chords, $\rn{V}\rnseven$, is
among the ones we still use today. Whereas others relied on
figured bass to explain their examples, Weber relied mostly
on Roman numerals.
