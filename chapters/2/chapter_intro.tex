...
% This is the introduction to \refchap{introductiontoromannumeralanalysis},
...
down a piece analytically. \reffig{rnandcl} shows a fragment
of music annotated with both Roman numeral and chord label
annotations.

\phdfigure[The first eight measures of Josephine Lang's Op.8 No.1 ``Schmitterling'', annotated with Roman numeral analysis and chord labels][1.0]{rnandcl}
