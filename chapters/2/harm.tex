The \code{**harm} syntax was proposed by David Huron as part
of the Humdrum (\code{**kern}) format. This syntax includes
...
The original \code{**harm} documentation is available
