...
discussion of some aspects of the notation that often vary.}
One way to investigate the different notational conventions
in \gls{rna} could be to observe, chronologically, the
practice of the notation over the years.
...
WorldCat\footnotelink{https://www.worldcat.org/} library
...
\reftab{primary_sources_table}.

\phdtablefith[All primary sources reviewed in terms of their
\gls{rna} syntax][0.9]{primary_sources_table}
...
\reffig{primary_sources/kirnberger1774kunst015}. Although
