...
\begin{enumerate}
    ...
    absent. Any change of key was notated with the colon
    syntax. Eventually, a few ways to notate common
    tonicizations (e.g., \emph{dominant of the dominant})
    became popular. These evolved into the slash syntax we
    use today, although it is unclear who should be credited
    for the slash notation
