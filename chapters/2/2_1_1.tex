...
A clear example of this can be seen in Loewengard's treatise \textcite{loewengard1908lehrbuch}, where the cadential six-four figure has the numeric inversion notation, but the ii6 chord in the same line does not (see Figure \ref{fig:loewengard1908lehrbuch045}).
...
The notation of \emph{VofV} is observed in the book of Mokrejs \textcite{mokrejs1913lessons}, which is shown in Figure \ref{fig:mokrejs1913lessons079}.
