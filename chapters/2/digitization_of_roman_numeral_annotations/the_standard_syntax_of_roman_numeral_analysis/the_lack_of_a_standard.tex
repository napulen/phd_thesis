...
% This is \refsubsubsec{thelackofastandard},
% which introduces the the lack of a standard.
...
chords are relatively standardized. These are indicated in table \reftab{inversions}

\input{\cwd/tables/inversions}
