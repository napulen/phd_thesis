...
% This is \refsec{romannumeralanalysisandchordlabels}, which
% introduces the roman numeral analysis and chord labels.

% Roman numeral labels provide more information than chord
% labels.
Chord labels, such as the ones shown in the lower
annotations of \reffig{rnandcl}, generally indicate the root
of a chord and its quality. Less frequently, they also
indicate the bass (which is included in \reffig{rnandcl} for
completeness). A Roman numeral label provides this
...
$\rntwo$ in seventh chords. In the modern syntax, it is also
customary to indicate \emph{applied chords} or
...
music of the 19\textsuperscript{th} century. Roman numerals
...
\reffig{rnandcl} indicates a \emph{dominant of the dominant}
...
piece.\footnote{See
\refsec{thestructureofaromannumeralanalysislabel} for a more
