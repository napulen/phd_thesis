...
online.\footnotelink{https://www.humdrum.org/Humdrum/representations/harm.rep.html}
...
numeral scale degree. This is useful when expressing a chord
root that is non-diatonic to the current key, or a
tonicization that is non-diatonic to the scale degrees of
the current key (when the altered Roman numeral appears in
the denominator).
