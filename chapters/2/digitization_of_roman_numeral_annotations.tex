...
only be achieved by standardizing the notation, and the
practice of \gls{rna}. Several notational systems have
emerged over the years to attempt to solve this problem.
