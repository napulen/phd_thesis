...
Neapolitan chords are a chromatic substitution of the subdominant chord.
...
\subsubsection{The RomanText syntax}
This notation was first proposed by Tymoczko et al. \parencite{tymoczko}.
The syntax is clearly explained in the conference publication.
The most prominent aspect of this notation is its software implementation as a module in the music21 Python library.

\subsubsection{The DCML syntax}
A notational system first introduced by \parencite{neuwirth}.

\subsubsection{The harmalysis grammar}
A Roman numeral analysis grammar introduced by N\'apoles L\'opez and Fujinaga \cite{napoleslopez}
