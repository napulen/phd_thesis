...
\refsec{effectsofdataaugmentation} describes the effects of
...
% the neural network to reconstruct the final \gls{rna}
% labels output by the system.
...
against previous approaches. \refsec{results} presents the
results of the evaluation. \refsec{discussion} discusses the
