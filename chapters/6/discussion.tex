...
might be the difference between a naive \gls{arna} model and
one that users might want to adopt. I consider we are
surrounded by many of those minuscule decisions.
