...
$\rnV\seven$ chord in measure 4, which is considered by the
analyst (and the \textcite{mcleod2021modular} model) as a
continuation of the chord in measure 3. Lastly, the model
...
to the tonic (i.e., $\rn{\musSharpIV}$). In this $\keyg$
