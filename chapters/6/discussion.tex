...
digitization of different \gls{rna} standards, it is often
challenging to know whether a model's mislabelling is due to
poor performance, or due to a mistranslation somewhere in
the training/inference process. This is perhaps one of the
issues that need more immediate attention from the
community, if there's a desire for better \gls{arna} models.