...
\refsubsubsec{numberofconvolutionallayers}) and use the
...
that the blocks processing \gls{bass19} and \gls{chroma19}
are identical in structure. Thus, two blocks are
