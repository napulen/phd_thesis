...
\refsubsubsec{numberoffilters}) of each layer. These are
shown in \reffig{ablation_baseline_convolutional}. 

\phdfigure[The configuration of the convolutional blocks in
the baseline \gls{crnn} used for the ablation
studies]{ablation_baseline_convolutional}
