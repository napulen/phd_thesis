...
the baseline in most tasks. In a subsequent experiment, the
advantage of the linear dense variation faded away after
introducing data augmentation, with an average drop of
