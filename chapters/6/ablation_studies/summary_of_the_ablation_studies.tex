...
hypothesis that estimating musical keys requires longer-term
musical context than estimating chords, which is coherent
musically. indicate which are generally the tasks with the
