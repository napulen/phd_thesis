...
contributions of the different components of the model, but
do not provide information about how the modified models
scale with more data. That is, the design of a neural
network architecture is importantly an empirical process,
which requires continuous experimentation. For this reason,
the baseline model presented in this section was used in
subsequent experiments, as it is the version of the network
that went through more experiments.