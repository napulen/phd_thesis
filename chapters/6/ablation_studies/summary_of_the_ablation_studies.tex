...
% A less prominent change is
% the one related the use of a constant number of filters.
% Although the performance is lower than the baseline, it lies
% within a standard deviation for all tasks, a detrimental
% effect that seemed more impactful during preliminary
% experiments.
Most modifications in the ablation studies have
a negative effect compared to the baseline model. One exception is the use of the pitch spelling
