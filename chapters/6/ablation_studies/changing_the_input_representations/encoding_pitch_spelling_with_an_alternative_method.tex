...
\phdfigure[Modification proposed for an ablation study,
where the method for encoding pitch spellings is the one in
\textcite{micchi2020not} (see
\refsubsubsec{encodingnoteswithspelling})]{ablation1}
