...
shown in \reffig{ablation7}.

\phdfigure[Modifications proposed in the seventh ablation
study, where all the convolutional layers have been removed.
This is expected to affect the chord segmentation and other
``short-term'' musical tasks]{ablation7}
