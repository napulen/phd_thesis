...
% In order to illustrate the comparison procedure, the
% excerpt in \reffig{haydnsample} is used to sample inputs
% and outputs from each model. The outputs were
% standardized, if needed, to a comparable format
