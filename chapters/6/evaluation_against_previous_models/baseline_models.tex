...
\reffig{haydn_no3_4_comparisonsample} is used to demonstrate
...
\phdfigure[An excerpt from the test set, Haydn's Op. 20 No.3
- IV, used to illustrate the inputs and outputs of the
models compared]{haydn_no3_4_comparisonsample}
