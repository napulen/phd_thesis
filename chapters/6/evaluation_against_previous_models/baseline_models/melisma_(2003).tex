...
\gls{humkern}. \reftab{haydn_no3_4_comparisonsample_melisma}
shows the representation of the input (left) and output
annotations (right) provided by \gls{melisma}.

\phdtablefitv[Example input (left column) and output (right
column) for the music excerpt in
\reffig{haydnsample}][0.4]{haydnsample_melisma}
