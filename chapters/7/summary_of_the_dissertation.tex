...
neural network into \gls{rna} annotations, which are part of
the end-to-end system. Those postprocessing methods are
based mostly on music theory domain knowledge.
