...
and the motivation to solve it. Although several systems for
analyzing harmony exist, \gls{rna} has been a popular method
used mostly for Western tonal music of the common-practice
period. It is possible that this is because this system
allows analysts to explain complicated concepts (e.g.,
chromatic changes of harmony) with a relatively simple
syntax. From an \gls{mir} perspective, it is also a very
interesting problem because it encapsulates the task of
recognizing chords and keys simultaneously. Thus, it
provides a framework to design more complex tonal analysis
models, and unified datasets to train and evaluate such
models.
