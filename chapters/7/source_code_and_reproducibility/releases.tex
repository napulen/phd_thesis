...
% v1.2.0 - Making the four-note output the default method for
%     reconstructing Roman numerals - By default, 8 tasks will
%     be computed 
...
%     classes, a more robust vocabulary than PitchClassSets94
%     - This means that v1.2.4 is backwards-incompatible with
%     models trained on previous versions v1.3.0 - Replacing
%     romanNumeralFromChord with custom chord vocabulary -
%     Using this chord vocabulary not only at inference, but
%     for standardizing the input training data
