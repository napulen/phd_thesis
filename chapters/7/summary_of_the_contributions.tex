...
the context of data augmentation, a technique was presented
in \refsubsec{synthesisofartificialexamples}. Although less
impactful than transposition, it presents the advantage that
it can be used in combination, increasing the performance
obtained by the network on the same dataset when using
transposition and synthesis of training examples.
