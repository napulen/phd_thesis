...
presented in this dissertation focused solely in the use of
symbols, conventions, and specificities of the \gls{rna}
notation that were relevant for its digitization and
standardization.

\refchap{dataacquisitionandpreparation} documented the
...
\refsubsec{preprocesseddata} of this chapter, the
...
\refsubsec{synthesisofartificialtrainingexamples}. Although
...
\refchap{modeldesign} described a novel neural network
...
tasks that has a more balanced distribution of target
...
studies shown in \refsubsec{summaryoftheablationstudies}.
The alternative representation of pitch spelling described
in \refsubsubsec{encodingnoteswithspelling} was also shown
