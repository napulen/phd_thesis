...
the \keyDs{} key. After closer inspection, it seems all of
these annotations come from a single piece, Op. 131 No. 7.
Unfortunately, it also seems that the strong presence of
\keyDs{} is unjustified, being instead a mislabeled
modulation towards the key of \keyD{}. Errors like this one
are occassional in all of the datasets. The objective
metrics help to identify them, but it remains to be one of
most time-consuming tasks in the development of a
\glspl{rna} system.
