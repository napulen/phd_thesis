\renewcommand{\absdir}{chapters/4}
...
\phdsection{available datasets}
    ...
    \phdsubsection{music theory examples (MuThEx)}
        \input{\absdir/_dataset_musictheorytextbooks}
...
\phdsection{data preparation}
    \phdsubsection{encoding issues}
        \input{\absdir/_encoding_translation_issues}
        \input{\absdir/_are_localkeys_modulations}
