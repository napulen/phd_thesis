...
provide this type of annotation (\gls{cadentialsixfour} chords)
...
\refsec{thevocabularyofmusicalkeys}), making it one of the
...
unjustified and an example of the second error pattern
discussed in \refsubsubsec{commonerrorpatterns}. Errors like
this one are occassional in all of the datasets. The search
for the common error paterns helps to identify them, but it
remains to be one of most time-consuming issues to address
in the development of an \gls{arna} system. The
