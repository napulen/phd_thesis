...
(denominator), 8) pedal ending, and 9) phrase
ending.\footnotelink{https://github.com/DCMLab/ABC}

\phdparagraph{Revised annotations (version 2)}

A revision of the \gls{dcml} standard notation (see
\refsubsubsec{theDCMLstandard}) lead to a new version of
this dataset in 2021. The new version of the dataset, in
addition to the new harmonic analysis standard, introduces
corrections in the annotations and additional
files.\footnotelink{https://github.com/DCMLab/ABC/tree/v2}
