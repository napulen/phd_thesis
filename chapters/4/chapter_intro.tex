...
workflows. \refsec{romannumeralanalysisdata} introduces the
definition of a Roman numeral dataset.
\refsec{availabledatasets} introduces the publicly available
datasets used in this research.
\refsec{aggregatingallavailabledatasets} describes the steps
followed to aggregate all the available datasets into a
unified dataset. \refsec{dataaugmentation} introduces the
