...
approach is to synthesize training examples as block chords,
such as the ones shown in \reffig{block_chord_sequence}.
These block chords are useful to indicate what are the notes
of the chord and which of those notes is the lowest-sounding
note. 
