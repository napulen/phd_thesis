...
\phdfigure[A possible solution to the first harmony
exercise proposed
\reffig{hindemith1943concentrated}]{synthesis_voiceleading}
...
\reffig{synthesis_blockchord}. These block chords are useful
...
for voice leading rules]{synthesis_blockchord}
