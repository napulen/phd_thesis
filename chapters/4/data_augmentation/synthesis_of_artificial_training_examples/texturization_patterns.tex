...
chosen limitation to lower the complexity of the
texturization algorithm. The use of nonchord tones could
presumably provide additional performance benefits at the
expense of a more sophisticated texturization logic.