...
\reffig{synthesis_blockchord} with an \emph{Alberti bass}
...
\phdfigure[A random texturization of some block chords in
\reffig{synthesis_blockchord} with a \emph{Bass split}
...
\phdfigure[A random texturization of some block chords in
\reffig{synthesis_blockchord} with a \emph{Syncopation}
