...
the most widely used. The toolkit was developed in the early 1990s and first thoroughly described in the \emph{Humdrum Toolkit: Reference Manual} \parencite{huron1994humdrum}.
...
\begin{itemize}
    ...
    extended with \code{C} tools known as Humdrum Extra
    and Humlib.
...
The \code{**kern) symbolic music representation is very compact, and tailored toward music analysis. The content can be typed by a human encoder and analyzed with the toolkit scripts.
