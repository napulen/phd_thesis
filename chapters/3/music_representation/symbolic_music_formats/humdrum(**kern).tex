...
from which the \code{**kern} representation for musical
...
\begin{enumerate}
    \item It already provides support for \gls{rna} using the Humdrum\code{**harm} syntax, which is also the pioneering representation for digital \gls{rna} annotations
    \item Historically, the first end-to-end system for \glspl{rna} was developed to operate with Humdrum(\code{**kern}) scores, generating automatic Humdrum(\code{**harm}) annotations for them
\end{enumerate}
