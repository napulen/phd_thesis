...
As of version 4.0 of the \gls{musicxml} format, there is a dedicated \code{<numeral>} element\footnotelink{https://www.w3.org/2021/06/musicxml40/musicxml-reference/elements/numeral/} to encode \gls{rna} annotations.
