...
\phdsection{music information retrieval}
    \phdsubsection{symbolic music representations}
        \phdinput{_symbolic_vs_audio}
    ...
    \phdsubsection{automatic key estimation}
        ...
        \phdsubsubsection{survey 2}
            \phdinput{_keyfinding_background}
        \phdsubsubsection{local key, tonicization, and modulation}
            \phdinput{_tonicization_modulation}
