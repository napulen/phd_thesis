...
\textcite{hochreiter1997long}. Since its introduction, the
\gls{lstm} has become increasingly popular and used for
several tasks and problems. \gls{lstm} architectures extend
the basic structure of \glspl{rnn} and it is relatively safe
to assume that any problem that involves an \gls{rnn} can
substitute the \gls{rnn} with an \gls{lstm}, matching or, often, improving the results.
