...
to be improved. Among the landscape of existing technologies nowadays, \glspl{cnn}, \glspl{rnn}, and Transformer networks have been applied to \glspl{rna}.

% These technologies have been applied to multiple \gls{mir}
% tasks. The most popular ones have already been discussed,
% however, other applications include the historical
% \gls{som} in the early 2000s
...
% liang2015contentaware, dawson2018keyfinding,
% valk2018deep}.
