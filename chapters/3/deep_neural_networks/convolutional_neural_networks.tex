...
\acrfull{cnn} were introduced during the
...
results in many tasks. For example, they were the technology
behind every state-of-the-art \emph{ImageNet} model from
2012 to 2020 \parencite{krizhevsky2012imagenet}, identifying
over 1,000 classes of objects in an image.
...
Throughout the years, researchers have proposed different
modifications to \glspl{cnn}, which have improved the
suitability of these models to certain problems and
scenarios.