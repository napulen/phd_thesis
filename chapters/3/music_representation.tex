...
Retrieval (\gls{mir}) is to encode musical information in a
...
music-streaming service. Many \gls{mir} tasks operate on audio
data because of the importance of audio representations in
the daily experience of music.
