...
% This is \refsubsec{automaticchordrecognition},
% which introduces the automatic chord recognition.


Automatic Chord Recognition (ACR) has been explored
thoroughly in the field of \gls{mir}. ACR systems typically seek to predict the root and
