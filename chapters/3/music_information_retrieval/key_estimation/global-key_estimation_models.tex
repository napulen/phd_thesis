...
% Temperley (1999)
Responding to some concerns about the Krumhansl-Schmuckler
algorithm, \textcite{temperley1999whats} proposed
two modifications to the original algorithm. The first
modification consisted in replacing the Pearson correlation
function with a dot product. The second modification was a
