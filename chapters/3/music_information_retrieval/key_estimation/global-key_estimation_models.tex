...
In the second stage, the algorithm tries to match the
...
is not quantitatively evaluated but an example of the keys
tracked in Chopin's Prelude Op. 28 No. 20 is provided,
...
they denominated ``cognition-inspired'' models, against
models derived from machine learning techniques. The
