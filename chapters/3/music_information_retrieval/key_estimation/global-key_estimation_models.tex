...
simultaneously tries predicts chords and keys in audio
signals. Their model is an extension of a previous model by
...
\parencite{mcennis2005jaudio} and a \cls{knn} classifier.
