...
analyses were performed using the Melisma Music Analyzer
\parencite{temperley2004cognition}. The corpus for
performing the harmonic analysis was obtained from
mididb.com, and consisted 1046 \gls{midi} files of Rock
music. The annotated files were synthesized with a
