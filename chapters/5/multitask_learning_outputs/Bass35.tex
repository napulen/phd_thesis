...
representations, all the pitches in the \gls{satb35}
classifiers have been encoded using the $\vocabps_35$
vocabulary. This was done in order to use the same loss
function (sparse categorical cross entropy) across all the
multitask learning tasks.
