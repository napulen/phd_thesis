...
One of the limitations with the previous method based on 35
features is that the it cannot encode any notes sharper than
...
requires 12 classes:\footnote{When enharmonic equivalence is
assumed in a \gls{12tet} system, a set of 12 pitch classes
spans all the note classes of the Western chromatic scale.}
