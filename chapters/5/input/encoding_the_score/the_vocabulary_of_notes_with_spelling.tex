...
method for encoding pitch spelling is to constrain a certain
number of accidentals (e.g., 2), and encode each of those
spelling classes as one dimension in a vector. This method
