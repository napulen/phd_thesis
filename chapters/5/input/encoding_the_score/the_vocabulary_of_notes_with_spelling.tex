...
classes. This method is the one used in
\textcite{micchi2020not, micchi2021deep} for an \gls{arna}
model. Using this approach representation, a 35-dimensional
pitch-spelling vector is encoded every timestep, indicating
the active pitch (or pitches) of the 35 available classes.
