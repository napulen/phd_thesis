...
\refeq{pitch_spelling_35}. A ``one-hot'' encoding utilizing
this method means that, at each timestep, the pitch spelling
will be encoded as one active class out of the 35 possible
spellings.
