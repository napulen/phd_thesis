...
In addition to belonging to one of these pitch classes, a
spelled note has a corresponding letter (e.g., $C\sharp$ is
pitch class 1, with the name $C$). Using this information, a
pitch class vector can be complemented with the generic note
letter representation of a particular note. This results in
19 features (12 pitch classes, plus 7 note letter names).
