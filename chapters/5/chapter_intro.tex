...
annotations. \refsec{input} describes the input of the
system. \refsec{theconvolutionalblocks} describes the
...
\refsec{multitasklearningoutputs} describes the multitask
learning configurations in the output layer of the neural
network model.
\refsec{fromoutputpredictionstoromannumerallabels} describes
the methods to generate the Roman numeral labels from the
predictions of the network. Lastly, \refsec{implementation}
