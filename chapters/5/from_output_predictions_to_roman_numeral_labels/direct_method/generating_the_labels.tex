...
\begin{enumerate} 
    ...
    \item The tonicization $\eldenpred$ is a relative scale
    degree of the key $\elkeypred$
...
\pdhtable[Resolving the encoding of tonicizations]{directmethod_rna_tonicization}
