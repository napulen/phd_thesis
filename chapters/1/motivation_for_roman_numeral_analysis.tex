...
their \gls{rna} labels (annotated below the notes in the
figure) are not. This is because in \gls{rna}, not only the
chords are important, but also the context of the musical
key.
