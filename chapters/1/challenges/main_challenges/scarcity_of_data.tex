...
\phdtwofigures[Handwritten digits to be annotated as in the \gls{mnist} dataset][Succession of chords to be annotated with \gls{rna} labels][0.3][0.7]{mnist}{chords}
