...
\textcite[10]{huron2016voice}.\footnotelink{https://github.com/napulen/romanyh}
...
``avoid augmented melodic intervals'' literally (above), and
a revised version, which accomodates for augmented unisons
(below)]{bach_bwv347_voiceleading}
...
\reffig{bach_bwv347_voiceleading}. Interpreting the outputs
