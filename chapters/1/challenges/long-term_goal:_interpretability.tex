...
computer within hours. \reffig{bach_bwv347_voiceleading}
...
\phdfigure[Output of a voice-leading algorithm. The input to
the algorithm were \gls{rna} annotations from a J. S. Bach
chorale (BWV 347). Two versions of the algorithm are
displayed, one that implements the voice-leading rule
``avoid augmented melodic intervals'' literally, and a
revised version, which accomodates for augmented
unisons]{bach_bwv347_voiceleading}
...
\reffig{bach_bwv347_voiceleading}. Implementing the
algorithm was useful to become aware of this scenario, where
the rule did not work properly. One could argue that
