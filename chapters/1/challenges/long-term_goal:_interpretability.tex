...
generated from the \gls{rna} annotations of J. S. Bach's BWV
347 (mm. 1--2). Two versions are offered, one that
implements the rule ``avoid augmented melodic intervals''
literally, and a revised version, which accomodates for
augmented unisons]{bach_bwv347_voiceleading}
