...
generated from the \gls{rna} annotations in a J. S. Bach
chorale, BWV 347 (mm. 1--2). Two versions are offered, one
that implements the rule ``avoid augmented melodic
intervals'' literally, and a revised version, which
accomodates for augmented unisons]{bach_bwv347_voiceleading}

One challenge in the development of this algorithm was
that some rules seemed to be detrimental to good voice
leading when they were enforced textually. For example, the
rule about augmented intervals
...
\reffig{bach_bwv347_voiceleading}. Implementing this
