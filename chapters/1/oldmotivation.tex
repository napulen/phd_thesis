...
% I would cut this duplication of the above: In spite of
% their compactness, Roman numeral strings are sufficient to
% provide all of these features, and thus show to be
% convenient as an annotation system for creating functional
% harmony datasets.
