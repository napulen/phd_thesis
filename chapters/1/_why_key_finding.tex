...
% Sapp \cite{sapp2011computational} studied tonality through
...
by Longuet-Higgins \cite{longuethiggins1971interpreting},
...
\cite{gomez2006tonal, campbell2010automatic,
...
\cite{mauch2010approximate, chai2005detection}. Another
...
According to Vos \cite{vos2000tonality}, there is a natural
...
keys \cite{korzeniowski2018harmonic}  could reduce its
...
revisits this issue \cite{krumhansl2004cognition}, surveying
...
\cite{sapp2011computational}, which allow the computation of
...
\cite{vos2000tonality}, Vos argues that one of the root
...
In her dissertation \cite{chew2000towards}, Chew introduced
...
\cite{harte2006detecting}. Such representations are very
...
In their study, Chai and Vercoe \cite{chai2005detection}
...
dissertation \cite{budge1943study}, Bellmann
\cite{bellmann2006about} designed a \emph{key profile} to be
used with a new key-finding algorithm. The resulting
key-finding algorithm outperformed the accuracy of the
Krumhansl-Schmuckler algorithm
\cite{krumhansl1990cognitive}, using solely information
...
\cite{quinn2010are}. Quinn considers that these questions
...
\cite{white2018chord}, a Hidden Markov Model (HMM) was given
