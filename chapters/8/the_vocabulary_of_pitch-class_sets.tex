...
pitch class set (\gls{pcset}) can be a subset $\elpcset
\subset C$ comprising the pitch classes of a given triad or
seventh chord. Several chord labels and/or \gls{rna}
annotations may share the same \gls{pcset}, as shown in
...
of all \gls{rna} labels $\setrna$ is that, because of the
collisions of many chords, $| \setpcset | << | \setrna |$.
