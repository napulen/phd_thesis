...
shown in \refeq{pcset_collision}.
...
disadvantage of this is that many \gls{rna} labels will
result in the same \gls{pcset}, which is problematic when
the goal is to recover the original \gls{rna} back.
Nevertheless, using the musical key and the algorithm
described in
