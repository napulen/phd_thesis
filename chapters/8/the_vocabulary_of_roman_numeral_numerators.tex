...
\refeq{minor_numerators}. If $\elden_{\elkey}$ is a major
key, there are 20 possible values for $\elnum$; if $\elden$
is a minor key, there are 19 possible values for $\elnum$.
