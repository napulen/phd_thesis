...
annotations shown in \refeq{rn_two_annotations}, the symbols
are $\elkey=\keyG$, $\elden=\keyG$, and $\elnum=\rnVsev$,
for the first annotation, and $\elkey=\keyG$,
$\elden=\keyG$, and $\elnum=\rnI$, for the second
annotation.

\begin{equation}
    \label{eq:rn_two_annotations}
    \rn{G}:\rnVsev \;\;\;\; \rnI
\end{equation}
