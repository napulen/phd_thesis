...
$\setkey$, and $\setden$, among others, such that any
$\elnum$, $\elkey$, and $\elden$ can be assumed to belong to
those vocabularies, as shown in \refeq{rn_vocabularies}.

\begin{equation}
    \label{eq:rn_vocabularies}
    \begin{split}
    \elnum \in \setnum \\
    \elkey \in \setkey \\
    \elden \in \setden
