...
If we consider an \gls{rna} label to be a ``fraction-like''
...
half-diminished seventh chord. The inversion is generally a
stack of Arabic numerals, which in this case is absent (see
\refsec{thevocabularyofarabicnumeralinversions} for further
discussion on inversions).
...
\refeq{rn_example3}, $\elden = \rnI \implies \keyG$.
...
\refeq{rn_three_annotations}, which are read from left to
...
In most instances, an \gls{rna} label will be made of only a
