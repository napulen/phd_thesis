...
that $\elden = \elkey$. For example, in the annotation shown
in \refeq{rn_example3}, $\elden = \elkey = \keyG$.
...
$\forall \elnum \in \setnum$, $\forall \elkey \in \setkey$,
and $\forall \elden \in \setden$ for all the annotations
presented throughout the chapters. This complementary
information facilitates the interpretation of \gls{rna}
labels in the context of this dissertation.
