...
In the more complicated case where $\elkey \not\in
\setkey_\elpcset$, for a given $\elpcset$, the numerator
$\elnum$ will be retrieved with an estimated $\elden \in
\setkey_\elpcset$ as $\Gamma(\elpcset, \elden) = \elnum$.
...
to the tonicized key $\elden$.

The next section describes the process of obtaining
$\elden$.
