...
\begin{equation}
    ...
    \begin{cases}
        \keyC & \text{ is the \gls{pcset}(\elkey:\elnum) if } \elnum = \rnvisev \\
        \keye & \text{ is the \gls{pcset}(\elkey:\elnum) if } \elnum = \rnivsev \\
        \keyF & \text{ is the \gls{pcset}(\elkey:\elnum) if } \elnum = \rniiisev \\
        \keyG & \text{ is the \gls{pcset}(\elkey:\elnum) if } \elnum = \rniisev \\
        \keya & \text{ is the \gls{pcset}(\elkey:\elnum) if } \elnum = \rnisev \\
    \end{cases}
\end{equation}
