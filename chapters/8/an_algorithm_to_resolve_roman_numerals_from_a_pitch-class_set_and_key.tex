...
predicted $\elpcsetpred$\footnote{It is customary in machine
learning literature to use the ``hat'' symbol to refer to
the predictions of a machine learning system.} and
$\elkeypred$ of a machine learning system. The reason is
