...
% Let $\Gamma(\elpcset, \elkey)$ be a lookup table that returns
% a Roman numeral $\elnum \in \chi$ for all pairs of ($\elpcset$,
% $\elkey$) for which there is a Roman numeral association. 
