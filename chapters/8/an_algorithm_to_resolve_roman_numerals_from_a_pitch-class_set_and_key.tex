...
\begin{equation}
    ...
    \begin{cases}
        \keyC & \text{ is the pcset}(\elkey:\elnum)\text{ if } \elnum = \rnvisev \\
        \keye & \text{ is the pcset}(\elkey:\elnum)\text{ if } \elnum = \rnivsev \\
        \keyF & \text{ is the pcset}(\elkey:\elnum)\text{ if } \elnum = \rniiisev \\
        \keyG & \text{ is the pcset}(\elkey:\elnum)\text{ if } \elnum = \rniisev \\
        \keya & \text{ is the pcset}(\elkey:\elnum)\text{ if } \elnum = \rnisev \\
    \end{cases}
\end{equation}
