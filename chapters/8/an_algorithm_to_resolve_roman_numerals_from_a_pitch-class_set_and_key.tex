...
\begin{equation}
    \label{eq:pcset_ceg}
    \pcsetcega \text{ in key } \elkey =
    \begin{cases}
        \keyC & has a numerator \elnum = \rnvisev \\
        \keye & has a numerator \elnum = \rnivsev \\
        \keyF & has a numerator \elnum = \rniiisev \\
        \keyG & has a numerator \elnum = \rniisev \\
        \keya & has a numerator \elnum = \rnisev \\
    \end{cases}
\end{equation}
