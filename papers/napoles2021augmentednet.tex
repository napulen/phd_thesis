...
% \guide{The pioneers.}
% The first computational efforts around functional harmony can be traced back to Winograd \cite{winograd_linguistics_1968} and Maxwell \cite{maxwell_expert_1992}. Winograd's program required heavy preprocessing of the inputs (e.g., removing all non-chord tones beforehand), while Maxwell's expert system consisted of 55 handcrafted rules, designed to analyze short movements of French suites by Bach.
...
% We use the largest dataset of Roman Numeral Analysis annotations currently available \cite{gotham_romantext_2019}. This dataset consists of original annotations, additionally to the translation of existing datasets into a common, RomanText, representation. The original annotations include Bach's Well-Tempered Clavier, Monteverdi madrigals, and nineteenth-century songs. The translations include TAVERN \cite{devaney_theme_2015}, ABC \cite{neuwirth_annotated_2018}, and the MTG Haydn String Quartets \cite{napoles_lopez_automatic_2017}.