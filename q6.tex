\chapter{Local and global musical keys}
\label{chap:chap60}

\begin{quote}
    How does one deal with the problem of local key v. global key. (i.e., tonicization, modulation, and the key of the whole movement) in symbolic music analysis? [3-5 pages]
\end{quote}
\clearpage
...
In music theory, \emph{modulation}, \emph{applied dominants}, and \emph{tonicization} are related (but not interchangeable) terms that describe the change of the musical key throughout the piece. The term \emph{modulation} is at least as old as Jean-Philippe Rameau's \emph{Trait\'e de l'harmonie} \cite{rameau_treatise_1971}, while the terms \emph{applied dominant} and \emph{tonicization} seem to have emerged from the functional theory of Riemann around the 19th century \cite{gollin_reception_2012}.
...
% \subsection{What is a tonicization?}
...
% \subsection{Differentiating a modulation from a tonicization}
...
% \subsection{Dealing with keys in computational studies}
...
%  \section{On the unambiguous determination of local and global keys}
...
% \subsection{The length of a piece}
